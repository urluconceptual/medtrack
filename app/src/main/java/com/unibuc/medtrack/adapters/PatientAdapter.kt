...
class PatientAdapter(private val patients: List<UserModel>) :
    ...
    fun updateData(newPatients: List<UserModel>) {
        (patients as MutableList).clear()
        (patients as MutableList).addAll(newPatients)
